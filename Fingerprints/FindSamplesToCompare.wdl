...
workflow FindSamplesToCompare {
    ...
    input {
        ...
        Boolean skip_fingerprinting = false
   ...
   Array[Array[String]] matches = select_first(PickMatches.matches, transpose([input_callset, sample_names_to_compare, ground_truth_files, sample_names_to_compare]))
    ...
    scatter(matchArray in matches) {
            ...
            call ExtractSampleFromCallset as ExtractTruthFromCallset {
              input:
                callset=match.rightFile,
                sample=match.rightSample,
                basename=match.rightSample + ".extracted"
            }
            ...
            call Benchmark.Benchmark as BenchmarkVCF{
                input:
                     ...
                     truthVcf = ExtractTruthFromCallset.output_vcf,
                     confidenceInterval = truthIntervals[match.rightFile],
                     truthLabel = match.rightSample,
                     truthVcfIndex = ExtractTruthFromCallset.output_vcf_index,
                     reference = ref_fasta,
