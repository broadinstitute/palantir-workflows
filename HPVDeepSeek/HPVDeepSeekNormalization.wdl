...
task NormalizeHPVCounts {
    ...
    command <<<
        ...
        cthpvdna_per_human_genome_equivalents=$((~{top_hpv_num_reads} / gap_num_reads / 2))
        cthpvdna_per_ml_plasma=$((~{top_hpv_num_reads} / ml_plasma))
        cthpvdna_per_ng_cfdna=$((~{top_hpv_num_reads} / ng_cfdna))
        cthpvdnd_per_human_genome_equivalents_per_ml_plasma=$((cthpvdna_per_human_genome_equivalents / ~{ml_plasma}))
