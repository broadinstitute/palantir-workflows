...
workflow Glimpse2ImputationCheckQC {
    input {
        File qc_metrics
    ...
    call Glimpse2ImputationCheckQCTask {
        input:
    ...
    output {
        Boolean qc_passed = Glimpse2ImputationCheckQCTask.qc_passed
        File qc_failures = Glimpse2ImputationCheckQCTask.qc_failures
    }
}

task Glimpse2ImputationCheckQCTask {
    input {
        File qc_metrics
        File qc_metrics_thresholds
        String output_basename
