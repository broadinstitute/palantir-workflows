...
workflow ScoringImputedDataset {
  ...
  call ScoreVcfGatk as ScoreImputedArray {
  	input:
...
task ScoreVcfGatk {
  ...
  output {
  	File score = "~{basename}.scores.tsv"
  }
}
...
task AdjustScores {
	...
	command <<<
        ...
        population_data = inner_join(population_pcs, population_scores, by=("IID"="#IID"))
        ...
        array_scores = inner_join(array_pcs, array_scores, by=("IID"="sample"))
